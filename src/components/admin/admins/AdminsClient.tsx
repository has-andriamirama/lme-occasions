...
export default function AdminsClient({ admins: initialAdmins, currentAdminId }: Props) {
			...
			{deleteId && (
				<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-dark-950/80 backdrop-blur-sm">
					<div className="bg-dark-800 border border-dark-700 rounded-2xl p-6 w-full max-w-sm shadow-card-lg animate-scale-in">
						...
						<p className="text-sm text-dark-400 mb-6">Cette action est définitive et ne peut pas être annulée.</p>

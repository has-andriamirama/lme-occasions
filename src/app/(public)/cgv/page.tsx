				...
				<div className="prose prose-invert prose-sm max-w-none space-y-8 text-dark-300">
					{[
						...
						},
						{
							...
							content: `Pour réserver un véhicule, le client est invité à verser un acompte de 30% du prix de vente total du véhicule. Cet acompte est encaissé immédiatement par voie électronique sécurisée (Stripe). La réservation est enregistrée dès réception du paiement ; elle est définitivement confirmée par nos équipes lors de la présentation du client en agence.`,
						},
						{

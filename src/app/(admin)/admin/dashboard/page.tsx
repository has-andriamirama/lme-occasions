...
async function getStats() {
  ...
  const [
    ...
    prisma.reservation.aggregate({ where: { status: { in: ['CONFIRMED', 'COMPLETED'] }, reservedAt: { gte: monthStart } }, _sum: { depositAmount: true } }),
    prisma.reservation.findMany({
      where: { status: { in: ['CONFIRMED', 'COMPLETED', 'EXPIRED'] } },
